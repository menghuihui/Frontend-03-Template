...
function layout(element) {
    ...
    var minSize,mainStart, mainEnd, mainSign, mainBase, crossSize, crossStart, crossEnd, crossSign, crossBase;
    ...
    if(!style[mainSize]){
        ...
        for(var i = 0; i< items.length; i++){
            var item = items[i];
            if(itemStyle[mainSize] !== null || itemStyle[mainSize] !== null){
    ...
    if(!style[crossSize]){
        ...
        for(var i = 0; i < flexLines.length; i++){
            elementStyle[crossSize] = elementStyle[crossSize] + flexLines
        }
    }else{
